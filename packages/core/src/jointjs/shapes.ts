  ...
  joint.shapes.devs.Model.define(
    "devs.Type",
    {
      ...
      attrs: {
        ...
        ".sub-label": {
          ...theme.header.subLabel,
          refX: "50%",
          y: theme.header.height + 10,
        },
        ".header": {
    ...
    {
      markup:
        '<rect class="container"/><rect class="header"/><text class="label"/><text text-anchor="middle" class="sub-label"/><rect class="divider" />',
