            ...
            types: [
                    ...
                    fields: [
                        {
                            ...
                            args: [
                                ...
                                {
                                    name: "offset",
                                    description: "Skips the specified number of resources in the result set.",
                                    type: {
                                        kind: "SCALAR",
                                        name: "Int",
                                        ofType: null
                ...
                },
                {
                    ...
                    inputFields: [
                        ...
                        {
                            name: "name",
                            description: "Returns only characters matching the specified full character name (e.g. Spider-Man).",
                            type: {
                                kind: "SCALAR",
                                name: "String",
                                ofType: null
                        ...
                        {
                            name: "nameStartsWith",
                            description: "Returns characters with names that begin with the specified string (e.g. Sp).",
                            type: {
                                kind: "SCALAR",
                                name: "String",
                                ofType: null
                        ...
                        {
                            name: "modifiedSince",
                            description: "Returns only characters which have been modified since the specified date.",
                            type: {
                                kind: "SCALAR",
                                name: "String",
                                ofType: null
                        ...
                        {
                            name: "comics",
                            description: "Returns only characters which appear in the specified comics (accepts a comma-separated list of ids).",
                            type: {
                                kind: "LIST",
                                name: null,
                                ofType: {
                        ...
                        {
                            name: "series",
                            description: "Returns only characters which appear the specified series (accepts a comma-separated list of ids).",
                            type: {
                                kind: "LIST",
                                name: null,
                                ofType: {
                        ...
                        {
                            name: "events",
                            description: "Returns only characters which appear in the specified events (accepts a comma-separated list of ids).",
                            type: {
                                kind: "LIST",
                                name: null,
                                ofType: {
                        ...
                        {
                            name: "stories",
                            description: "Returns only characters which appear the specified stories (accepts a comma-separated list of ids).",
                            type: {
                                kind: "LIST",
                                name: null,
                                ofType: {
                ...
                },
                {
                    ...
                    enumValues: [
                        {
                            name: "name_asc",
                            description: "Returns character in A-Z order (i.e 3-D Man, A-Bomb (HAS), A.I.M, etc...)",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                        ...
                        {
                            name: "modified_asc",
                            description: "Returns character's modification date in ascending order",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "modified_desc",
                            description: "Returns character's modification date in descending order",
                            isDeprecated: false,
                            deprecationReason: null
                        }
                    ],
                ...
                },
                {
                    ...
                    inputFields: [
                        ...
                        {
                            name: "dateRange",
                            description: "Returns comics within a predefined date range. Dates must be specified as date1,date2 (e.g. 2013-01-01,2013-01-02). Dates are preferably formatted as YYYY-MM-DD but may be sent as any common date format.",
                            type: {
                                kind: "SCALAR",
                                name: "Int",
                                ofType: null
                ...
                },
                {
                    ...
                    enumValues: [
                        {
                            name: "magazine",
                            description: "Return only series containing one or more comics with the specified format of a magazine.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "trade_paperback",
                            description: "Return only series containing one or more comics with the specified format of a trade paperback.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "hardcover",
                            description: "Return only series containing one or more comics with the specified format of a hardcover.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "digest",
                            description: "Return only series containing one or more comics with the specified format of a digest.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "graphic_novel",
                            description: "Return only series containing one or more comics with the specified format of a graphic novel.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "comic",
                            description: "Return only series containing one or more comics with the specified format of a comic.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "digital_comic",
                            description: "Return only series containing one or more comics with the specified format of a digital comic.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "infinite_comic",
                            description: "Return only series containing one or more comics with the specified format of an infinite comic.",
                            isDeprecated: false,
                            deprecationReason: null
                        }
                    ],
                ...
                },
                {
                    ...
                    enumValues: [
                        {
                            name: "collection",
                            description: "Filter the series with a collection publication frequency.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "one_shot",
                            description: "Filter the series with a one shot publication frequency.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "limited",
                            description: "Filter the series with a limited publication frequency.",
                            isDeprecated: false,
                            deprecationReason: null
                        },
                        {
                            name: "ongoing",
                            description: "Filter the series with a ongoing publication frequency.",
                            isDeprecated: false,
                            deprecationReason: null
                        }
                    ],
